...
class CategoryDetails extends React.Component{
  render(){
    ...
    <a className="nav-link active" aria-current="page" href="./"><img src={logo} alt="logo"/></a>
    ...
    <ul className="navbar-nav me-auto ml-2 mb-lg-0">
      ...
      <a className="nav-link active" aria-current="page" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-facebook" viewBox="0 0 16 16">
      ...
      <div className="footer">
        <footer>
          ...
          <div className="container-body">
            ...
            <div className="column3" height="10vh"> 
              <div className="row">
                <img src={logo} alt="logo"/>
                <div className="copyright">
                   Copyright © C.C Bolivar 2021
                </div>
              </div>
            </div>
          </div>
